...
class TestAdmin:
    def test_return_to_home(self,browser_instance):
        ...
        adminpage.list_admin(self.driver)
        adminpage.home(self.driver)
    ...
    def test_create_user(self,browser_instance):
       ...
       #self.driver.find_element(By.XPATH, "//input[@name='username']").send_keys(usernamevalue2)
        ...
        adminpage.inputusername(self.driver)
        adminpage.inputpassword(self.driver)
        ...
        adminpage.dropdown(self.driver)
