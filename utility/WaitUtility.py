...
class WaitUtility:
    ...
    def wait_until_clickable(self, driver, element):
        WebDriverWait(driver, self.EXPLICIT_WAIT).until(EC.element_to_be_clickable(element)) #ec-expected condition

    def wait_until_clickable1(self, driver, element):
        WebDriverWait(driver,6).until(EC.element_to_be_clickable(element))
